/* **********************************************
Created Time: 2013年09月26日 星期四 00时26分18秒
File Name   : 桌面/code/2013南京网络赛/hdu 4757.cpp
*********************************************** */
#include <cstdio>
#include <cstring>
#include <algorithm>
...
namespace M
{
    ...
    void Insert(int &new_rt,int rt,int v) {
        newnode(new_rt,rt); int pre = new_rt;
        int p = rt, now = new_rt;
        for(int i = 0; i < 16; i++) {
            int c = v>>(15-i)&1;
            p = ch[p][c];
